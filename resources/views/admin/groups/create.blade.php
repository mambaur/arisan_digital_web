                ...
                <div class="card-body">
                    <form action="{{ route('group_store') }}" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <select class="form-select @error('periods_type') is-invalid @enderror" name="periods_type">
                                    <option value="monthly" @if(old('periods_type') == 'monthly') selected @endif>Monthly</option>
                                    <option value="weekly" @if(old('periods_type') == 'weekly') selected @endif>Weekly</option>
                                </select>
                                @error('periods_type')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="periods_date"
                                    ...
                                    id="datepicker-humanfd" value="{{ old('periods_date') }}">
                                @error('periods_date')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" type="text" rows="5" name="notes" value="{{ old('notes') }}"></textarea>
                            </div>
                        </div>
