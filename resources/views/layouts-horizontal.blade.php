                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <div class="popular-product-img p-2">
                                            <img src="{{ URL::asset('assets/images/product/img.png') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('assets/images/product/img-8.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('assets/images/flags/us.jpg') }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('assets/images/flags/italy.jpg') }}"
                                                            class="rounded" alt="user-image" height="18">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('assets/images/flags/spain.jpg') }}"
                                                            class="rounded" alt="user-image" height="18">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('assets/images/flags/french.jpg') }}"
                                                            class="rounded" alt="user-image" height="18">
                                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}"
                                                        alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Willie Verner
                                                    </div>
