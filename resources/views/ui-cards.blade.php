...
@section('body')
    ...
    @section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <img class="card-img img-fluid" src="{{ URL::asset('assets/images/small/img-6.jpg') }}"
                        alt="Card image">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="row" data-masonry='{"percentPosition": true }'>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <img src="{{ URL::asset('assets/images/small/img-5.jpg') }}" class="card-img-top"
                                alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <img src="{{ URL::asset('assets/images/small/img-7.jpg') }}" class="card-img-top"
                                alt="...">
                        </div>
                    </div><!-- end col -->
