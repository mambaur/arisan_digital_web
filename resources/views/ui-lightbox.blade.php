                    ...
                    <div class="card-body">
                        <div class="popup-gallery">
                            <div class="row">
                                ...
                                <div class="col-xl-2 col-md-4 col-6">
                                    <div class="mt-4">
                                        <a href="{{ URL::asset('assets/images/small/img-2.jpg') }}"
                                            class="thumb preview-thumb image-popup">
                                            <div class="img-fluid">
                                ...
                                <div class="col-xl-2 col-md-4 col-6">
                                    <div class="mt-4">
                                        <a href="{{ URL::asset('assets/images/small/img-5.jpg') }}"
                                            class="thumb preview-thumb image-popup">
                                            <div class="img-fluid">
                                ...
                                <div class="col-xl-2 col-md-4 col-6">
                                    <div class="mt-4">
                                        <a href="{{ URL::asset('assets/images/small/img-6.jpg') }}"
                                            class="thumb preview-thumb image-popup">
                                            <div class="img-fluid">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="">
                                    <a href="{{ URL::asset('assets/images/small/img-4.jpg') }}"
                                        ...
                                        <img src="{{ URL::asset('assets/images/small/img-4.jpg') }}" class="img-fluid"
                                            alt="work-thumbnail">
                                    </a>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="mt-4 mt-md-0">
                                    <a href="{{ URL::asset('assets/images/small/img-5.jpg') }}"
                                        ...
                                        data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit">
                                        <img src="{{ URL::asset('assets/images/small/img-5.jpg') }}" class="img-fluid"
                                            alt="work-thumbnail">
                                    </a>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="mt-4 mt-lg-0">
                                    <a href="{{ URL::asset('assets/images/small/img-1.jpg') }}"
                                        ...
                                        data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit">
                                        <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" class="img-fluid"
                                            alt="work-thumbnail">
                                    </a>
                                </div>
                            </div><!-- end col -->
