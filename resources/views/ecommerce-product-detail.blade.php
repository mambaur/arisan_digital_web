                                        ...
                                        <div thumbsSlider="" class="swiper product-nav-slider mt-2 overflow-hidden">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('assets/images/product/img-2.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('assets/images/product/img-3.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('assets/images/product/img-6.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img
                                                            src="{{ URL::asset('assets/images/product/img-5.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="desc" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-3 col-md-3">
                                                    <div>
                                                        <img src="{{ URL::asset('assets/images/product/img.png') }}"
